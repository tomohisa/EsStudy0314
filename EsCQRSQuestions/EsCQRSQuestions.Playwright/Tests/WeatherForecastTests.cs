...
using EsCQRSQuestions.Playwright.PageObjects;
    ...
    public class WeatherForecastTests : BaseTest
    {
        ...
        public async Task WeatherForecastCrudOperations()
        {
            ...
            try
            {
                ...
                int tokyoIndex = Array.IndexOf(locations, "Tokyo");
                int newYorkIndex = Array.IndexOf(locations, "New York");
                ...
                int kyotoIndex = Array.IndexOf(locations, "Kyoto");
