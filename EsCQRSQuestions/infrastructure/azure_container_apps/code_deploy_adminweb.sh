...
FRONTEND_FQDN="$(get_containerapp_fqdn "$FRONTEND_APP_NAME")"
...
az_retry containerapp update \
  ...
  --set-env-vars ASPNETCORE_URLS=http://+:8080 services__apiservice__http__0="$API_BASE_URL" services__apiservice__https__0="$API_BASE_URL" services__webfrontend__http__0="$CLIENT_BASE_URL" ClientBaseUrl="$CLIENT_BASE_URL"
